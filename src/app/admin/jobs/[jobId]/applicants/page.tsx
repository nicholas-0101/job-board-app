          ...
          <CardContent>
            <div className="grid gap-3 md:grid-cols-6 mb-3">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFilters({ ...filters, expectedSalaryMin: e.target.value })
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  setFilters({ ...filters, expectedSalaryMax: e.target.value })
                }
                  ...
                  <Card className="shadow-md hover:shadow-lg transition-all duration-300">
                    <CardContent className="p-5">
                      <div className="flex items-center gap-3 mb-3">
                        <img
                          src={a.profilePicture || "/fallback_pfp_image.jpg"}
                          alt={a.userName}
                        ...
                        <div className="mb-3">
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                              a.preselectionPassed
                                ? "bg-green-100 text-green-700"
                                : "bg-red-100 text-red-700"
                            }`}
                          >
                            Test: {a.score}/25{" "}
                            {a.preselectionPassed ? "✓ Passed" : "✗ Failed"}
                          </span>
                        </div>
                      )}
                      ...
                      <div className="flex gap-2 flex-wrap">
                        ...
                        <Button
                          size="sm"
                          onClick={() =>
                            onUpdateStatus(a.applicationId, "INTERVIEW")
                          }
                        ...
                        <Button
                          size="sm"
                          onClick={() =>
                            onUpdateStatus(a.applicationId, "ACCEPTED")
                          }
                        ...
                        <Button
                          size="sm"
                          onClick={() =>
                            onUpdateStatus(a.applicationId, "REJECTED")
                          }
                        ...
                        >
                          <td className="p-4">
                            <div className="flex items-center gap-3">
                              <img
                                src={
                                  a.profilePicture || "/fallback_pfp_image.jpg"
                                }
                                alt={a.userName}
