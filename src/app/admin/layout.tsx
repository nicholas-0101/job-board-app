              ...
              <Card className="shadow-lg border-t-4 border-t-[#24CFA7]">
                ...
                <CardContent className="pt-0 space-y-3">
                  <nav className="space-y-2 text-sm">
                    <Link
                      href="/admin"
                      className="flex items-center gap-3 rounded-xl px-4 py-3 hover:bg-gradient-to-r hover:from-[#467EC7]/10 hover:to-[#24CFA7]/10 transition-all group"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="text-[#467EC7] group-hover:scale-110 transition-transform"
                      >
