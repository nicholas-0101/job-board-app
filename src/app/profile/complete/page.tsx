...
export default function CompleteProfilePage() {
  ...
  return (
    <div className="min-h-screen pb-30 bg-gradient-to-br from-[#467EC7]/10 via-white to-[#24CFA7]/10 flex items-center justify-center p-4 relative overflow-hidden">
      <motion.div
