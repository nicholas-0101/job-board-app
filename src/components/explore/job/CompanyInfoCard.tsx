...
export default function CompanyInfoCard({ company }: CompanyInfoCardProps) {
  ...
  return (
    ...
    >
      ...
      {company.description && (
        <div
          className="prose prose-sm sm:prose-base text-muted-foreground mt-6 max-w-none
                     prose-headings:text-foreground prose-headings:font-bold prose-headings:mt-4 sm:prose-headings:mt-6 prose-headings:mb-2 sm:prose-headings:mb-3
                     prose-h1:text-xl sm:prose-h1:text-2xl prose-h1:text-foreground prose-h1:font-extrabold prose-h1:mb-3 sm:prose-h1:mb-4
                     ...
                     prose-p:text-muted-foreground prose-p:leading-relaxed prose-p:mb-3 sm:prose-p:mb-4 prose-p:text-sm sm:prose-p:text-base prose-p:font-normal
                     prose-ul:text-muted-foreground prose-ul:mb-3 sm:prose-ul:mb-4 prose-ul:list-disc prose-ul:pl-6 sm:prose-ul:pl-8
                     prose-ol:text-muted-foreground prose-ol:mb-3 sm:prose-ol:mb-4 prose-ol:list-decimal prose-ol:pl-6 sm:prose-ol:pl-8
          ...
          dangerouslySetInnerHTML={{
            __html: DOMPurify.sanitize(company.description).replace(
              /<ul>/g, 
