...
import {
  ...
  DROPDOWN_CHECKBOX_ITEM_CLASSES,
  DROPDOWN_RADIO_ITEM_CLASSES,
  DROPDOWN_LABEL_CLASSES,
  DROPDOWN_SEPARATOR_CLASSES,
  DROPDOWN_SUB_TRIGGER_CLASSES,
  DROPDOWN_SUB_CONTENT_CLASSES,
  DROPDOWN_SHORTCUT_CLASSES,
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(DROPDOWN_ITEM_CLASSES, className)}
      {...props}
    />
  )
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(DROPDOWN_SUB_TRIGGER_CLASSES, className)}
      {...props}
    >
      {children}
