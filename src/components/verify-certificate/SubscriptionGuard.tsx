...
import { Shield, Award, LogIn } from "lucide-react";
          ...
          <div className="text-center mb-8">
            <div className="flex items-center gap-3 justify-center mb-4">
              <div className="p-2 bg-[#467EC7]/10 rounded-lg">
                <Shield className="w-6 h-6 text-[#467EC7]" />
              </div>
              <h1 className="text-3xl font-bold text-gray-900">Certificate Verification</h1>
            </div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Verify the authenticity of skill assessment certificates
            </p>
          </div>
            ...
            <CardContent className="p-12">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-[#467EC7]/10 rounded-full mb-6">
                  <Shield className="w-10 h-10 text-[#467EC7]" />
                </div>
                <h2 className="text-3xl font-bold text-[#467EC7] mb-4">
                  Subscription Required
                </h2>
                <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                  Certificate Verification is a premium feature that requires an active
                  subscription. Upgrade your account to verify skill assessment certificates,
                  check authenticity, and access detailed certificate information.
                </p>
