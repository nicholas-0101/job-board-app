...
export default function ConditionalLayout({
  ...
  const isPublicPage =
    isAdminPage || isDeveloperPage || isAuthPage || isProfilePage;
  ...
  return (
    <>
      ...
      <main
        className={
          !isDeveloperPage && !isAdminPage && !isAuthPage && !isProfilePage
            ? "flex-1 pt-16"
            : "flex-1"
        }
      >
        {!isPublicPage ? <UserGuard>{children}</UserGuard> : children}
      </main>
