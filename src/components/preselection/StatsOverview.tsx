...
import { Briefcase, TestTube, CheckCircle, XCircle, Circle } from "lucide-react";
...
export function StatsOverview({ tests }: StatsOverviewProps) {
  ...
  const stats = [
    ...
    { label: "Draft Tests", value: draftCount, icon: XCircle, color: "from-orange-500 to-orange-600" },
    { label: "Inactive Tests", value: inactiveCount, icon: Circle, color: "from-gray-500 to-gray-600" },
  ];
