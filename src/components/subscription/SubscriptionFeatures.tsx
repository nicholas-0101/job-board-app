...
const features: FeatureItem[] = [
  {
    icon: FileText,
    title: "CV Generator",
    description: "Create professional, ATS-friendly CVs with customizable templates",
    available: 'both'
  },
  {
    icon: Target,
...
const getFeatureAvailability = (available: string) => {
  switch (available) {
    case 'both':
      return { text: 'All Plans', color: '#24CFA7' };
    case 'professional':
      return { text: 'Professional Only', color: '#467EC7' };
    case 'standard':
